...
const NextJs = ({ size = "md" }) => {
  return (
    <svg className={`w-${sizeList[size]} h-${sizeList[size]}`} width="1em" height="1em" viewBox="0 0 180 180" fill="none" xmlns="http://www.w3.org/2000/svg"><mask id="mask0_408_139" style={{
      maskType: "alpha"
